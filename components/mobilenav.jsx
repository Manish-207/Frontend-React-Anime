    ...
    <div className="md:hidden">
        ...
        <nav className="flex  items-center justify-between h-16 px-4 text-amber-50">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="text-white text-2xl rounded-full p-2 bg-[#393c49] hover:bg-[#4a4d5a] transition"
            >
              <CiSearch />
            </button>
            <button className="text-white text-2xl rounded-full p-2 bg-[#393c49] hover:bg-[#4a4d5a] transition">
              <FaRegUser />
            </button>
          </div>
        </nav>
      ...
      {searching && (
        <div className="flex items-center gap-2  h-16 px-3 py-2 w-full max-w-md mx-auto ">
          <div className="bg-[#3a3d4a] rounded-full flex items-center gap-2 w-full px-3 py-2 ">
            {/* Search Icon */}
          ...
          <button
            onClick={() => onSearchClick()}
            className="text-white text-xl flex-shrink-0 hover:bg-[#4a4d5a] bg-[#3a3d4a] rounded-full  p-3 transition"
          >
            <RxCross2 />
          </button>
        </div>
