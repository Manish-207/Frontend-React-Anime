...
import bgImage from "../assets/imgintro.webp";
    ...
    <div className="bg-gradient-to-r  from-purple-900 to-indigo-900 text-white">
      ...
      >
        ...
        <header className="relative z-10 flex items-center px-8 py-6">
          <img src={logo} alt="Aniverse" className="w-46" />
        </header>
      ...
      <section className="py-16 px-6 ">
        ...
        <div className=" max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-gradient-to-r from-purple-700 via-purple-800 to-indigo-900 rounded-lg p-6 hover:scale-105 transition transform">
