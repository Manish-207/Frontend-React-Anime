...
const Poster = ({
  ...
  return (
    <div className="w-48 bg-transparent text-white rounded-sm overflow-hidden ">
      {/* === Image Section === */}
      <div className="relative h-64 rounded-sm overflow-hidden group hover:scale-[1.02] transition-all duration-300">
        {/* Background Image */}
        <div
